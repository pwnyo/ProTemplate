...
import theFallenHuman.cards.basic.Defend;
import theFallenHuman.cards.basic.Strike;
import theFallenHuman.relics.TodoItem;

import java.util.ArrayList;

import static theFallenHuman.UndertaleMod.*;

public class TheFallenHuman extends CustomPlayer {
    ...
    static final String ID = makeID("TheFallenHuman"); //TODO: Change this
    static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
    static final String[] NAMES = characterStrings.NAMES;
    static final String[] TEXT = characterStrings.TEXT;


    public TheFallenHuman(String name, PlayerClass setClass) {
    ...
    public AbstractPlayer newInstance() {
        return new TheFallenHuman(name, chosenClass);
    }
    ...
    public static class Enums {
        //TODO: Change these.
        @SpireEnum
        public static AbstractPlayer.PlayerClass UT_HUMAN;
        @SpireEnum(name = "UT_BLACK")
        public static AbstractCard.CardColor UT_BLACK;
        @SpireEnum(name = "UT_BLACK")
        @SuppressWarnings("unused")
        public static CardLibrary.LibraryType UNDERTALE_BLACK;
    }
}
