...
import theTrickster.cards.Defend;
import theTrickster.cards.Strike;
import theTrickster.relics.TodoItem;

import java.util.ArrayList;

import static theTrickster.TheTricksterMod.*;
...
public class TheTrickster extends CustomPlayer {
    ...
    public CharSelectInfo getLoadout() {
        return new CharSelectInfo(NAMES[0], TEXT[0],
                70, 70, 1, 99, 5, this, getStartingRelics(),
    ...
    public static class Enums {
        //TODO: Change these.
        @SpireEnum
        public static AbstractPlayer.PlayerClass JOKER;
        @SpireEnum(name = "JOKER_BLACK")
        public static AbstractCard.CardColor TWILIGHT_BLACK;
        @SpireEnum(name = "JOKER_BLACK")
        @SuppressWarnings("unused")
        public static CardLibrary.LibraryType JOKER_BLACK;
    }
}
