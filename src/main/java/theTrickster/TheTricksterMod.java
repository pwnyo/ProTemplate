...
import theTrickster.cards.AbstractEasyCard;
import theTrickster.cards.cardvars.SecondDamage;
import theTrickster.cards.cardvars.SecondMagicNumber;
import theTrickster.relics.AbstractEasyRelic;

import java.nio.charset.StandardCharsets;

@SuppressWarnings({"unused", "WeakerAccess"})
@SpireInitializer
public class TheTricksterMod implements
        EditCardsSubscriber,
    ...
    public TheTricksterMod() {
        ...
        BaseMod.addColor(TheTrickster.Enums.TWILIGHT_BLACK, characterColor, characterColor, characterColor,
    ...
    public static void initialize() {
        TheTricksterMod thismod = new TheTricksterMod();
    }

    @Override
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new TheTrickster(TheTrickster.characterStrings.NAMES[1], TheTrickster.Enums.JOKER),
                CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, TheTrickster.Enums.JOKER);
    }
