...
import theTrickster.util.CardArtRoller;

import java.util.ArrayList;

import static theTrickster.TheTricksterMod.*;
import static theTrickster.util.Wiz.atb;
import static theTrickster.util.Wiz.att;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, TheTrickster.Enums.TWILIGHT_BLACK);
    }
