...
import undertale.cards.Defend;
import undertale.cards.Strike;
import undertale.relics.TodoItem;

import java.util.ArrayList;

import static undertale.TheFallenHuman.Enums.FALLENHUMAN_UT_BLACK;
import static undertale.Undertale.*;
...
public class TheFallenHuman extends CustomPlayer {
    ...
    static final String ID = makeID("TheFallenHuman");
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_FALLEN_HUMAN;
        @SpireEnum(name = "FALLENHUMAN_UT_BLACK")
        public static AbstractCard.CardColor FALLENHUMAN_UT_BLACK;
        @SpireEnum(name = "FALLENHUMAN_UT_BLACK")
