...
import undertale.util.CardArtRoller;

import java.util.ArrayList;

import static undertale.Undertale.*;
import static undertale.util.Wiz.atb;
import static undertale.util.Wiz.att;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target,TheFallenHuman.Enums.FALLENHUMAN_UT_BLACK);
    }
